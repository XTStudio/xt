...
class WXRunner {
    ...
    startProject() {
        ...
        const toolProcess = child_process.exec('/Applications/wechatwebdevtools.app/Contents/MacOS/cli --build-npm ' + path_1.resolve('platform', 'wx') + ' -o ' + path_1.resolve('platform', 'wx'), { cwd: './' });
